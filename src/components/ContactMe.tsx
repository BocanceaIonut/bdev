  ...
  return (
    <div className="w-screen px-4 md:pr-32 md:pl-8">
      <div className="flex flex-col justify-center items-center w-full h-full">
        <h1 className="text-3xl md:text-4xl mb-6 md:mb-8 text-black font-bold">
          Contact Me
        </h1>
        <div className="bg-white p-4 md:p-8 rounded-lg shadow-lg w-full max-w-2xl border-2">
            ...
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-2 md:space-y-0 md:space-x-4">
              ...
              <div>
                ...
                <p className="text-sm md:text-base text-gray-600 break-all">
                  bocancea.gabriel.ionut@gmail.com
                </p>
              </div>
            </div>
            <div className="flex flex-col md:flex-row items-start md:items-center space-y-2 md:space-y-0 md:space-x-4">
              ...
              <div>
                ...
                <a
                  href="https://www.linkedin.com/in/ionut-gabriel-bocancea-8a06a11a3/"
                  target="_blank"
